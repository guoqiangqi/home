...
export default class Planet {
  constructor(options = {}) {
    ...
    this.textureName = options.texture || 'planetTexture'
    this.normalMapName = options.normalMap || 'planetNormal'
    this.displacementMapName = options.displacementMap || 'planetDisplacement'
  ...
  init() {
    ...
    const normalMap = this.resources.items[this.normalMapName]
    normalMap.generateMipmaps = true
    normalMap.minFilter = THREE.LinearMipMapLinearFilter
    normalMap.anisotropy = 8

    const displacementMap = this.resources.items[this.displacementMapName]
